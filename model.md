...
| 2026-05-31 | gates | keep | Trainable-candidate gates pass for all 7 roots after the 1440x1080 `visual_scale: 1` refresh; the gated mix validates as 304 images / 1160 boxes, package QA verifies physical count targets separately from fragment evidence, and the sampled 84-row visual audit pack defaults to easier low-clutter rows. Full P1 remains blocked by 0 promoted real stress labels. |
