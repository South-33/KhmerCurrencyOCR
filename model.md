...
Current evidence gap: P1 transfer still has 0 protected/promoted real fan/overlap stress labels. Existing `cashsnap_v1` mined review labels now provide 17 diagnostic-ready stress images / 35 boxes, including 10 held-out val/test rare/edge images / 13 boxes, but they are not rights-clean P1 fan/overlap transfer proof.
...
| 2026-06-05 | gates | keep | `check_synthetic_dataset_scorecard.py` now summarizes the PDF rubric over existing artifacts. Latest scorecard is `blocked` with `3` pass / `2` review / `4` blocked axes: pass for target-condition synthetic coverage, package label trust, and accepted-blend domain gap; blocked for real anchor/holdout, hard negatives, diagnostic real utility, and protected real utility; review for mined edge-case inventory and release-grade governance/provenance. |
...
| 2026-06-05 | real bridge | keep | Mined real review quality is now executable and partly audited. `manifests/mined_real_benchmark_review_quality.csv` marks 17 diagnostic-ready stress image(s) / 35 boxes and leaves the 3 messy simple-overlap image(s) / 10 boxes as `needs_review`; two wrong-class `KHR_50000` rows were rejected as visible `KHR_1000` backs. The held-out subset has 10 val/test rare/edge images / 13 boxes (`KHR_20000` 6, `KHR_50000` 3, `KHR_5000` 2, `KHR_500` 1, `KHR_1000` 1). |
