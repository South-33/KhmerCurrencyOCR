...
- WebGL clean/stack/fan/hand-occlusion/thin-edge modes support `--class-sequence` for targeted weak-denomination smoke/dose tests; `webgl_rare_class_support_v1` has a balanced 16-image rare-KHR distribution audit, but still needs real rare-class validation before trainable-candidate approval.
