...
| 2026-06-05 | evaluation | reject | Rare-support staged dose 2 is seed-fragile, not promotable. Seed 0 passed (`0.838473`, `+0.002612` vs matched p24 real-only, no per-class failures, worst `KHR_50000 -0.043206`), but seed 1 rejected (`0.826076`, `-0.009785`, worst `KHR_50000 -0.158238`, two per-class failures). Dose 1 is also rejected (`0.825533`, `-0.010328` vs p24, `KHR_50000 -0.143900`). Keep the class-balanced rare-support package as diagnostic signal, but do not scale it until the seed sensitivity is understood or real-stress transfer validates it. |
