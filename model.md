...
- `check_synthetic_dataset_scorecard.py` turns the dataset-perfection rubric into a thin executable summary over readiness/domain-gap artifacts, mined-real review/quality artifacts, split class coverage, and mined held-out diagnostic utility comparisons. Current scorecard is blocked: synthetic coverage, package trust, and accepted-blend domain gap pass; real anchor/holdout, clean-real rare train coverage, hard negatives, diagnostic real utility, and protected real utility are blocked; mined edge-case inventory has 17 diagnostic-ready scoreable image(s) / 35 boxes, not protected transfer proof.
...
| 2026-06-05 | gates | keep | `check_synthetic_dataset_scorecard.py` now summarizes the PDF rubric over existing artifacts. Latest scorecard is `blocked` with `3` pass / `2` review / `5` blocked axes: pass for target-condition synthetic coverage, package label trust, and accepted-blend domain gap; blocked for real anchor/holdout, clean-real rare train coverage, hard negatives, diagnostic real utility, and protected real utility; review for mined edge-case inventory and release-grade governance/provenance. |
