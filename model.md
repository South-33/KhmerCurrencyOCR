...
- `audit_yolo_domain_gap.py` now has opt-in domain-gap gates for real-vs-synthetic image statistics, box geometry, and synthetic dose ratios; use it to keep future blends inside a measured real-distribution envelope before spending training runs.
